...
class MfnModelMini(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1_bn = self.__batch_normalization(2, 'conv1/bn', num_features=48, eps=9.999999747378752e-06, momentum=0.0)
        self.conv1_dw = self.__conv(2, name='conv1_dw', in_channels=48, out_channels=48, kernel_size=(3, 3), stride=(1, 1), groups=48, bias=False)
        self.conv1_dw_bn = self.__batch_normalization(2, 'conv1_dw/bn', num_features=48, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_ex = self.__conv(2, name='conv2_ex', in_channels=48, out_channels=96, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_ex_bn = self.__batch_normalization(2, 'conv2_ex/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_dw = self.__conv(2, name='conv2_dw', in_channels=96, out_channels=96, kernel_size=(3, 3), stride=(2, 2), groups=96, bias=False)
        self.conv2_dw_bn = self.__batch_normalization(2, 'conv2_dw/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_em = self.__conv(2, name='conv2_em', in_channels=96, out_channels=48, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_em_bn = self.__batch_normalization(2, 'conv2_em/bn', num_features=48, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_1_ex = self.__conv(2, name='conv2_1_ex', in_channels=48, out_channels=96, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_1_ex_bn = self.__batch_normalization(2, 'conv2_1_ex/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_1_dw = self.__conv(2, name='conv2_1_dw', in_channels=96, out_channels=96, kernel_size=(3, 3), stride=(1, 1), groups=96, bias=False)
        self.conv2_1_dw_bn = self.__batch_normalization(2, 'conv2_1_dw/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_1_em = self.__conv(2, name='conv2_1_em', in_channels=96, out_channels=48, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_1_em_bn = self.__batch_normalization(2, 'conv2_1_em/bn', num_features=48, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_2_ex = self.__conv(2, name='conv2_2_ex', in_channels=48, out_channels=96, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_2_ex_bn = self.__batch_normalization(2, 'conv2_2_ex/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_2_dw = self.__conv(2, name='conv2_2_dw', in_channels=96, out_channels=96, kernel_size=(3, 3), stride=(1, 1), groups=96, bias=False)
        self.conv2_2_dw_bn = self.__batch_normalization(2, 'conv2_2_dw/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_2_em = self.__conv(2, name='conv2_2_em', in_channels=96, out_channels=48, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_2_em_bn = self.__batch_normalization(2, 'conv2_2_em/bn', num_features=48, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_3_ex = self.__conv(2, name='conv2_3_ex', in_channels=48, out_channels=96, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_3_ex_bn = self.__batch_normalization(2, 'conv2_3_ex/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_3_dw = self.__conv(2, name='conv2_3_dw', in_channels=96, out_channels=96, kernel_size=(3, 3), stride=(1, 1), groups=96, bias=False)
        self.conv2_3_dw_bn = self.__batch_normalization(2, 'conv2_3_dw/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_3_em = self.__conv(2, name='conv2_3_em', in_channels=96, out_channels=48, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_3_em_bn = self.__batch_normalization(2, 'conv2_3_em/bn', num_features=48, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_4_ex = self.__conv(2, name='conv2_4_ex', in_channels=48, out_channels=96, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_4_ex_bn = self.__batch_normalization(2, 'conv2_4_ex/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_4_dw = self.__conv(2, name='conv2_4_dw', in_channels=96, out_channels=96, kernel_size=(3, 3), stride=(1, 1), groups=96, bias=False)
        self.conv2_4_dw_bn = self.__batch_normalization(2, 'conv2_4_dw/bn', num_features=96, eps=9.999999747378752e-06, momentum=0.0)
        self.conv2_4_em = self.__conv(2, name='conv2_4_em', in_channels=96, out_channels=48, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv2_4_em_bn = self.__batch_normalization(2, 'conv2_4_em/bn', num_features=48, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_ex = self.__conv(2, name='conv3_ex', in_channels=48, out_channels=224, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_ex_bn = self.__batch_normalization(2, 'conv3_ex/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_dw = self.__conv(2, name='conv3_dw', in_channels=224, out_channels=224, kernel_size=(3, 3), stride=(2, 2), groups=224, bias=False)
        self.conv3_dw_bn = self.__batch_normalization(2, 'conv3_dw/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_em = self.__conv(2, name='conv3_em', in_channels=224, out_channels=112, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_em_bn = self.__batch_normalization(2, 'conv3_em/bn', num_features=112, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_1_ex = self.__conv(2, name='conv3_1_ex', in_channels=112, out_channels=224, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_1_ex_bn = self.__batch_normalization(2, 'conv3_1_ex/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_1_dw = self.__conv(2, name='conv3_1_dw', in_channels=224, out_channels=224, kernel_size=(3, 3), stride=(1, 1), groups=224, bias=False)
        self.conv3_1_dw_bn = self.__batch_normalization(2, 'conv3_1_dw/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_1_em = self.__conv(2, name='conv3_1_em', in_channels=224, out_channels=112, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_1_em_bn = self.__batch_normalization(2, 'conv3_1_em/bn', num_features=112, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_2_ex = self.__conv(2, name='conv3_2_ex', in_channels=112, out_channels=224, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_2_ex_bn = self.__batch_normalization(2, 'conv3_2_ex/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_2_dw = self.__conv(2, name='conv3_2_dw', in_channels=224, out_channels=224, kernel_size=(3, 3), stride=(1, 1), groups=224, bias=False)
        self.conv3_2_dw_bn = self.__batch_normalization(2, 'conv3_2_dw/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_2_em = self.__conv(2, name='conv3_2_em', in_channels=224, out_channels=112, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_2_em_bn = self.__batch_normalization(2, 'conv3_2_em/bn', num_features=112, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_3_ex = self.__conv(2, name='conv3_3_ex', in_channels=112, out_channels=224, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_3_ex_bn = self.__batch_normalization(2, 'conv3_3_ex/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_3_dw = self.__conv(2, name='conv3_3_dw', in_channels=224, out_channels=224, kernel_size=(3, 3), stride=(1, 1), groups=224, bias=False)
        self.conv3_3_dw_bn = self.__batch_normalization(2, 'conv3_3_dw/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_3_em = self.__conv(2, name='conv3_3_em', in_channels=224, out_channels=112, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_3_em_bn = self.__batch_normalization(2, 'conv3_3_em/bn', num_features=112, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_4_ex = self.__conv(2, name='conv3_4_ex', in_channels=112, out_channels=224, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_4_ex_bn = self.__batch_normalization(2, 'conv3_4_ex/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_4_dw = self.__conv(2, name='conv3_4_dw', in_channels=224, out_channels=224, kernel_size=(3, 3), stride=(1, 1), groups=224, bias=False)
        self.conv3_4_dw_bn = self.__batch_normalization(2, 'conv3_4_dw/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_4_em = self.__conv(2, name='conv3_4_em', in_channels=224, out_channels=112, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_4_em_bn = self.__batch_normalization(2, 'conv3_4_em/bn', num_features=112, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_5_ex = self.__conv(2, name='conv3_5_ex', in_channels=112, out_channels=224, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_5_ex_bn = self.__batch_normalization(2, 'conv3_5_ex/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_5_dw = self.__conv(2, name='conv3_5_dw', in_channels=224, out_channels=224, kernel_size=(3, 3), stride=(1, 1), groups=224, bias=False)
        self.conv3_5_dw_bn = self.__batch_normalization(2, 'conv3_5_dw/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_5_em = self.__conv(2, name='conv3_5_em', in_channels=224, out_channels=112, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_5_em_bn = self.__batch_normalization(2, 'conv3_5_em/bn', num_features=112, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_6_ex = self.__conv(2, name='conv3_6_ex', in_channels=112, out_channels=224, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_6_ex_bn = self.__batch_normalization(2, 'conv3_6_ex/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_6_dw = self.__conv(2, name='conv3_6_dw', in_channels=224, out_channels=224, kernel_size=(3, 3), stride=(1, 1), groups=224, bias=False)
        self.conv3_6_dw_bn = self.__batch_normalization(2, 'conv3_6_dw/bn', num_features=224, eps=9.999999747378752e-06, momentum=0.0)
        self.conv3_6_em = self.__conv(2, name='conv3_6_em', in_channels=224, out_channels=112, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
        self.conv3_6_em_bn = self.__batch_normalization(2, 'conv3_6_em/bn', num_features=112, eps=9.999999747378752e-06, momentum=0.0)
        self.conv4_ex = self.__conv(2, name='conv4_ex', in_channels=112, out_channels=512, kernel_size=(1, 1), stride=(1, 1), groups=1, bias=False)
