...
train_loader = torch.utils.data.DataLoader(DataLmdb("D:\\_DNN_Opt\\LowDB\\Low_lmdb\\Train-Low_lmdb", db_size=143432, crop_size=128, flip=True, scale=0.00390625),
    batch_size=32, shuffle=True)
test_loader = torch.utils.data.DataLoader(DataLmdb("D:\\_DNN_Opt\\LowDB\\Low_lmdb\\Valid-Low_lmdb", db_size=7939, crop_size=128, flip=False, scale=0.00390625, random=False),
